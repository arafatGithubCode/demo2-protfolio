import { testimonial } from "../data/index.json";
          ...
          {testimonial &&
            testimonial.map((item, index) => (
              <div key={index} className="testimonial_item">
                <div className="testimonial_card_review">
                ...
                <div className="testimonial_author">
                  ...
                  <div className="testimonial_author_details">
                    <h4>{item.author_name}</h4>
                    <p className="text-sm">{item.author_designation}</p>
                  </div>
                </div>
              </div>
            ))}
